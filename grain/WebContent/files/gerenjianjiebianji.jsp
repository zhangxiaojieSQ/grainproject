...
-->
.del{background:url(../images/close2.png);
	width:30px;
	height:30px;
	display:none;
	position:absolute;
			...
			<TD width="100%">
				...
				<legend>张三</legend>
					  ...
					  <tr>
					    ...
					    <td width="86%" colspan="3"><img src="../images/20140410_095650.jpg"><input type="button" name="Submit" value="删除" class="button" onclick="alert('删除成功');"/></td>
					  </tr>
					   <tr>
